    ...
    namespace RegistrationService
    {
        ...
        internal class Program
        {
            ...
            static void SignIn()
            {
                ...
                while (CheckPassword(nicknames) == false)
                {
                    Console.BackgroundColor = ConsoleColor.Red;
                    Console.WriteLine("Nicknames is invalid. Nicknames must contain at least 1 UpperCase, 1 Digit, 1 Symbol and length 12");
                    Console.ResetColor();
                    nicknames = Console.ReadLine();
